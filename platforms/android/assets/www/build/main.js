...
BtcreceivedtransactionPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-btcreceivedtransaction',template:/*ion-inline-start:"D:\bccpayApp(version 2.0.5)\src\pages\btcreceivedtransaction\btcreceivedtransaction.html"*/'\n<ion-header>\n  <ion-navbar color="custom">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Received BTC</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content >\n      <div *ngFor="let item of transactionData" >\n        <div *ngIf="item.category == \'receive\'" class="card white-text blue lighten-1 margin padding">\n          <div class="row no-margin">\n            <span class="font-lighter">To:&nbsp;{{item.address}}</span><br>\n          </div>\n          <div class="row no-margin">\n            <div class="col-50 ">\n              <small class="valign-wrapper"><em>{{item.time* 1000 | date:\'dd-MM-yy HH:mm\'}}</em></small>\n              <a class="white-text" ng-click="transDetails(all.txid)">see details</a>\n            </div>\n            <div class="col-50 no-margin">\n              <div class="pull-right">\n                <span class="crypto-icon">Ƀ&nbsp;</span><span class="font-25">{{item.amount}}</span>\n              </div>\n            </div>\n          </div>\n        </div>\n     </div>  \n</ion-content>\n'/*ion-inline-end:"D:\bccpayApp(version 2.0.5)\src\pages\btcreceivedtransaction\btcreceivedtransaction.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */], __WEBPACK_IMPORTED_MODULE_2__services_setup_service__["a" /* SetupService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */]])
...
CryptosenttransactionPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-cryptosenttransaction',template:/*ion-inline-start:"D:\bccpayApp(version 2.0.5)\src\pages\cryptosenttransaction\cryptosenttransaction.html"*/'\n<ion-header>\n  <ion-navbar color="custom">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Sent BCH</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content >\n      <div *ngFor="let item of transactionData" >\n        <div *ngIf="item.category == \'send\'" class="card white-text orange lighten-1 margin padding">\n          <div class="row no-margin">\n            <span class="font-lighter">To:&nbsp;{{item.address}}</span><br>\n          </div>\n          <div class="row no-margin">\n            <div class="col-50 ">\n              <small class="valign-wrapper"><em>{{item.time* 1000 | date:\'dd-MM-yy HH:mm\'}}</em></small>\n              <a class="white-text" ng-click="transDetails(all.txid)">see details</a>\n            </div>\n            <div class="col-50 no-margin">\n              <div class="pull-right">\n                <span class="crypto-icon">Ƀ&nbsp;</span><span class="font-25">{{item.amount}}</span>\n              </div>\n            </div>\n          </div>\n        </div>\n     </div>  \n</ion-content>\n'/*ion-inline-end:"D:\bccpayApp(version 2.0.5)\src\pages\cryptosenttransaction\cryptosenttransaction.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */], __WEBPACK_IMPORTED_MODULE_2__services_setup_service__["a" /* SetupService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */]])
...
CryptoreceivedtransactionPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-cryptoreceivedtransaction',template:/*ion-inline-start:"D:\bccpayApp(version 2.0.5)\src\pages\cryptoreceivedtransaction\cryptoreceivedtransaction.html"*/'\n<ion-header>\n  <ion-navbar color="custom">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Received BCH</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content >\n      <div *ngFor="let item of transactionData" >\n        <div *ngIf="item.category == \'receive\'" class="card white-text blue lighten-1 margin padding">\n          <div class="row no-margin">\n            <span class="font-lighter">To:&nbsp;{{item.address}}</span><br>\n          </div>\n          <div class="row no-margin">\n            <div class="col-50 ">\n              <small class="valign-wrapper"><em>{{item.time* 1000 | date:\'dd-MM-yy HH:mm\'}}</em></small>\n              <a class="white-text" ng-click="transDetails(all.txid)">see details</a>\n            </div>\n            <div class="col-50 no-margin">\n              <div class="pull-right">\n                <span class="crypto-icon">Ƀ&nbsp;</span><span class="font-25">{{item.amount}}</span>\n              </div>\n            </div>\n          </div>\n        </div>\n     </div>  \n</ion-content>'/*ion-inline-end:"D:\bccpayApp(version 2.0.5)\src\pages\cryptoreceivedtransaction\cryptoreceivedtransaction.html"*/,
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ToastController */], __WEBPACK_IMPORTED_MODULE_2__services_setup_service__["a" /* SetupService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */]])
...
var SignupPage = (function () {
    function SignupPage(navCtrl, loadingCtrl, alertCtrl, menuCtrl, navParams, _setupService, toastCtrl) {
        this.navCtrl = navCtrl;
        this.loadingCtrl = loadingCtrl;
        this.alertCtrl = alertCtrl;
        this.menuCtrl = menuCtrl;
...
var SetupService = (function () {
    function SetupService(http) {
        this.http = http;
        this.endpoint_url = 'http://192.168.1.21:1338';
        this.http = http;
        console.log('Hello ServicesProvider Provider');
    }
    ...
    SetupService.prototype.chartAvailabelData = function (chartdata) {
        var response = this.http.post(this.endpoint_url + '/cexticker/getChart', chartdata).map(function (res) { return res.json(); });
        return response;
    };
    ...
    SetupService.prototype.getBidCoin = function () {
        var response = this.http.post(this.endpoint_url + '/cexticker/getCurrntPriceOfBTC', '').map(function (res) { return res.json(); });
        return response;
    };
